      ...
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .dark-pill {
          ...
          border-radius: 100px; padding: 7px 14px; font-size: 12px; font-weight: 500; color: #CBD5E1;
      ...
      <div className="left-panel">
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "40px 0", position: "relative", zIndex: 1 }}>
          ...
          <div style={{
            ...
            borderRadius: 100, padding: "6px 14px", fontSize: 12, fontWeight: 600, color: "#93C5FD",
          ...
          <h2 style={{
            fontFamily: "'DM Serif Display', serif", fontSize: "clamp(1.8rem, 3vw, 2.5rem)",
            fontWeight: 400, color: "#fff", lineHeight: 1.2, letterSpacing: "-0.025em", marginBottom: 12,
          }}>
          ...
          <div className="feature-row">
            <div className="feature-icon" style={{ background: "rgba(251,191,36,0.15)", border: "1px solid rgba(251,191,36,0.2)" }}>🔊</div>
            <div>
          ...
          <div className="feature-row">
            <div className="feature-icon" style={{ background: "rgba(96,165,250,0.15)", border: "1px solid rgba(96,165,250,0.2)" }}>💬</div>
            <div>
          ...
          <div className="feature-row">
            <div className="feature-icon" style={{ background: "rgba(52,211,153,0.15)", border: "1px solid rgba(52,211,153,0.2)" }}>✏️</div>
            <div>
        ...
        <div style={{ position: "relative", zIndex: 1, borderTop: "1px solid rgba(255,255,255,0.07)", paddingTop: 20 }}>
          <p style={{ fontSize: 13, color: "#475569" }}>
            Are you a student?{" "}
            <Link href="/student/login" style={{ color: "#60A5FA", fontWeight: 600, textDecoration: "none" }}>
              Student sign in →
            </Link>
          </p>
        </div>
      ...
      <div className="right-panel" style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: "48px 32px", background: "#fff" }}>
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <div style={{ marginBottom: 36 }}>
            <h1 style={{ fontFamily: "'DM Serif Display', serif", fontSize: 36, fontWeight: 400, letterSpacing: "-0.025em", color: "#0A0A0A", marginBottom: 8 }}>
              Welcome back.
            </h1>
