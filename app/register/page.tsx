...
export default function RegisterPage() {
  ...
  function validate(): boolean {
    ...
    if (!form.name.trim() || form.name.trim().length < 2) next.name = "School name must be at least 2 characters.";
    ...
    <div style={{ minHeight: "100vh", fontFamily: "'DM Sans', system-ui, sans-serif", display: "grid", gridTemplateColumns: "1fr 1fr" }}>
      ...
      <div className="left-panel">
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "36px 0" }}>
          ...
          <div style={{ background: "rgba(255,255,255,0.7)", border: "1px solid rgba(0,0,0,0.07)", borderRadius: 14, padding: "16px 18px", marginTop: 4, backdropFilter: "blur(8px)" }}>
            ...
            <p style={{ fontSize: 12, color: "#64748B", lineHeight: 1.6, marginTop: 6 }}>
              students in sub-Saharan Africa has a visual impairment affecting access to printed learning materials.
            </p>
          </div>
        </div>
        ...
        <p style={{ fontSize: 13, color: "#64748B" }}>
          ...
          <Link href="/login" style={{ color: "#1D4ED8", fontWeight: 600, textDecoration: "none" }}>Sign in here →</Link>
        </p>
      </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <div style={{ position: "relative" }}>
                <input className={`auth-input ${errors.password ? "err" : ""}`} type={showPass ? "text" : "password"} name="password" value={form.password} onChange={handleChange} placeholder="At least 8 characters" autoComplete="new-password" style={{ paddingRight: 44 }} />
